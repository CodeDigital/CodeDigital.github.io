class TriangleMeshing{
    ...
    deconstructAsTriangles(poly){
        ...
        while(cPoints.length > 0 || ccPoints.length > 0){
            ...
            // find which points denote concave portions (wether it's drawn clockwise or counterclockwise).
            if(cPoints.includes(leftMost)){ // ccPoints are concave
                ...
                triangles.push(new Triangle(concaveSet));
